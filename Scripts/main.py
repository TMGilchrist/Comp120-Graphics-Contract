...
feetPath = glob.glob(pathToAssets + "/Sprites/shoes/*" + spriteFileType)
...
newSprite = sprite((16, 16), random.choice(base), random.choice(legs), random.choice(body), random.choice(head), random.choice(feet), 0)
